...
def _guess_main_xml(obj: ObjectInfo) -> Optional[Path]:
    """Определить основной XML-файл документа."""
...
def parse_document_object(obj: ObjectInfo) -> None:
    """Парсинг одного документа: реквизиты, ТЧ, движения, ввод на основании."""
    ...
    # Движения через RegisterRecords
    ...
    # Альтернативный путь: Registers/* (в части конфигураций движения описаны так)
...
def parse_documents(graph) -> None:
    """Парсинг всех документов в графе."""
