...
class DependencyGraph:
    ...
    def __init__(self) -> None:
        ...
        self._edges_by_source: DefaultDict[str, List[Edge]] = defaultdict(list)
        self._edges_by_target: DefaultDict[str, List[Edge]] = defaultdict(list)
        self._edges_by_kind: DefaultDict[EdgeKind, List[Edge]] = defaultdict(list)
    ...
    def traverse(self, start: str, depth: int, direction: str = "outgoing") -> List[Tuple[Edge, int]]:
        ...
        Возвращает список кортежей (edge, level), где level начинается с 1.
        """
        ...
        seen_edges: Set[Tuple[str, str, EdgeKind, Tuple[Tuple[str, str], ...]]] = set()
